...
export default class Game extends Phaser.Scene {
    ...
    create(data: { network: Network }) {
        ...
        //const tilemap = this.make.tilemap({ key: 'maps' })
        //this.map.addTilesetImage('tiles')

        //const map = this.make.tilemap({ key: 'maps' })
        //const tileset = map.addTilesetImage('white', 'tiles')

        this.map = this.make.tilemap({ key: 'map' })
        //this.add.image(150, 150, 'tiles')

        const tileset = this.map.addTilesetImage('walle', 'tiles')
        const groundLayer = this.map.createLayer('base', tileset, 705, -500)
        const wallLayer = this.map.createLayer('wall', tileset, 705, -500)
        const wallOverLayer = this.map.createLayer(
            'wallover',
            tileset,
            705,
            -500
    ...
    private handlePlayerUpdated(
        ...
        /*console.log(
            'otherPlayer:' + id + ' field: ' + field + ' value: ' + value
        )*/
    }
